      ...
      <div className="hero-content flex-col lg:flex-row-reverse">
        ...
        <div>
          ...
          <p className="py-6">
            ...
            hier den Podcast.
            <br /> Weil ich selbst gerne Sprachen lerne (ja, es ist eines meiner
            Hobbys!), weiß ich, dass es oft gut ist, wenn man mit kurzen Texten
            lernen kann. Deswegen nehme ich kurze Podcast-Folgen auf.
            <br /> Hier seht ihr außer mir noch Maria, die auch Deutsch gelernt
            hat und weiter lernt. Wir stehen vor der Thai-Sala im Westpark in
            München, einem buddhistischen Heiligtum aus Thailand.
            <br /> Aber keine Angst, damit wollen wir nicht sagen, dass Deutsch
            genauso schwer zu lernen ist wie Thai.
          </p>
